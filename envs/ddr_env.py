...
class DynDiffRobot(KinDiffRobot, gym.Env):
    ...
    def _generate_random_dynamics(self):
...
if __name__ == '__main__':
    ...
    default_robot_config = {"dt": 0.1,
                            "max_dist_from_goal": 3,
                            "max_travelled_dist_of_wheels": 24,
                            "num_obstacles": 2,
                            "action_space_type": "discrete_complex",
                            "observation_space_type": "goal_gates_robot_dynamics",
                            "random_range": 1.,
                            "rendering": True,
